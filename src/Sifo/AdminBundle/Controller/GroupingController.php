...
use Sifo\SharedBundle\Entity\Grouping;
use Sifo\AdminBundle\Form\GroupingType;
...
class GroupingController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('SifoAdminBundle:index:grouping.html.twig', array(
            'entities'  => $pagination,
            'paginator' => $paginator, 
            'user'      => $user,
    ...
    private function createFilterForm()
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admin_grouping_grouping_filter'))
            ->setMethod('GET')
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_grouping_grouping_new', array('id' => $entity->getId())));
        }
    ...
    */
    private function createCreateForm(Grouping $entity)
    {
        $form = $this->createForm(new GroupingType(), $entity, array(
            'action' => $this->generateUrl('admin_grouping_grouping_create'),
            'method' => 'POST',
        ));
    ...
    public function showAction($id)
    {
        ...
        return $this->render('SifoAdminBundle:show:grouping.html.twig', array(
            'entity'      => $entity,
            'user'        => $user,
        ));
    }
    ...
    /**
    * Creates a form to edit a Grouping entity.
    *
    * @param Grouping $entity The entity
    *
    * @return \Symfony\Component\Form\Form The form
    */
    private function createEditForm(Grouping $entity)
    {
        $form = $this->createForm(new GroupingType(), $entity, array(
            'action' => $this->generateUrl('admin_grouping_grouping_update', array('id' => $entity->getId())),
            'method' => 'POST',
        ));
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_grouping_grouping_show', array('id' => $id)));
        }
    ...
    public function deleteAction(Request $request, $id)
    {
        ...
        return $this->redirect($this->generateUrl('admin_grouping_grouping'));
    }
    ...
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admin_grouping_grouping_delete', array('id' => $id)))
            ->setMethod('DELETE')
