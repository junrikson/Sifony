...
use Sifo\SharedBundle\Entity\BlogAgenda;
use Sifo\AdminBundle\Form\BlogAgendaType;
use Sifo\AdminBundle\Lib\Paginator;

/**
 * BlogAgenda controller.
 *
 */
class BlogAgendaController extends Controller
{
    /**
     * Lists all BlogAgenda entities.
     *
     */
    public function indexAction()
    {
        $user = $this->getUser();
        $repository = $this->getDoctrine()->getRepository('SifoSharedBundle:BlogAgenda');
        ...
        return $this->render('SifoAdminBundle:index:blog_agenda.html.twig', array(
            'entities'  => $pagination,
            'paginator' => $paginator, 
            'user'      => $user,
    ...
    private function createFilterForm()
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admin_blog_agenda_filter'))
            ->setMethod('GET')
    ...
    /**
     * Creates a new BlogAgenda entity.
     *
     */
    public function createAction(Request $request)
    {
        $user = $this->getUser();
        $entity = new BlogAgenda();
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_blog_agenda_new', array('id' => $entity->getId())));
        }
    ...
    /**
    * Creates a form to create a BlogAgenda entity.
    *
    * @param BlogAgenda $entity The entity
    *
    * @return \Symfony\Component\Form\Form The form
    */
    private function createCreateForm(BlogAgenda $entity)
    {
        $form = $this->createForm(new BlogAgendaType(), $entity, array(
            'action' => $this->generateUrl('admin_blog_agenda_create'),
            'method' => 'POST',
        ));
    ...
    /**
     * Displays a form to create a new BlogAgenda entity.
     *
     */
    ...
    /**
     * Finds and displays a BlogAgenda entity.
     *
     */
    public function showAction($id)
    {
        $user = $this->getUser();
        $em = $this->getDoctrine()->getManager();
        $entity = $em->getRepository('SifoSharedBundle:BlogAgenda')->find($id);

        if (!$entity) {
            throw $this->createNotFoundException('Unable to find BlogAgenda entity.');
        }

        return $this->render('SifoAdminBundle:show:blog_agenda.html.twig', array(
            'entity'      => $entity,
            'user'        => $user,
        ));
    }
    ...
    /**
     * Displays a form to edit an existing BlogAgenda entity.
     *
     */
    ...
    /**
    * Creates a form to edit a BlogAgenda entity.
    *
    * @param BlogAgenda $entity The entity
    *
    * @return \Symfony\Component\Form\Form The form
    */
    private function createEditForm(BlogAgenda $entity)
    {
        $form = $this->createForm(new BlogAgendaType(), $entity, array(
            'action' => $this->generateUrl('admin_blog_agenda_update', array('id' => $entity->getId())),
            'method' => 'POST',
        ));
    ...
    /**
     * Edits an existing BlogAgenda entity.
     *
     */
    public function updateAction(Request $request, $id)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_blog_agenda_show', array('id' => $id)));
        }
    ...
    public function removeAction($id)
    {
        ...
        return $this->render('SifoAdminBundle:remove:blog_agenda.html.twig', array(
            'entity'      => $entity,
            'form'        => $form->createView(),
            'user'        => $user,
        ));
    ...
    public function deleteAction(Request $request, $id)
    {
        ...
        return $this->redirect($this->generateUrl('admin_blog_agenda'));
    }

    /**
     * Creates a form to delete a BlogAgenda entity by id.
     *
    ...
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admin_blog_agenda_delete', array('id' => $id)))
            ->setMethod('DELETE')
