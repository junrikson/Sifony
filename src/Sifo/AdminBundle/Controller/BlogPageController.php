...
use Sifo\SharedBundle\Entity\BlogPage;
use Sifo\AdminBundle\Form\BlogPageType;
...
{
    /**
     * Lists all BlogPage entities.
     *
     */
    public function indexAction()
    {
        $user = $this->getUser();
        $repository = $this->getDoctrine()->getRepository('SifoSharedBundle:BlogPage');
        ...
        return $this->render('SifoAdminBundle:index:blog_page.html.twig', array(
            'entities'  => $pagination,
            'paginator' => $paginator, 
            'user'      => $user,
    ...
    private function createFilterForm()
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admin_blog_page_filter'))
            ->setMethod('GET')
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_blog_page_new', array('id' => $entity->getId())));
        }
    ...
    /**
    * Creates a form to create a BlogPage entity.
    *
    * @param BlogPage $entity The entity
    *
    * @return \Symfony\Component\Form\Form The form
    */
    private function createCreateForm(BlogPage $entity)
    {
        $form = $this->createForm(new BlogPageType(), $entity, array(
            'action' => $this->generateUrl('admin_blog_page_create'),
            'method' => 'POST',
        ));
    ...
    /**
     * Displays a form to create a new BlogPage entity.
     *
     */
    ...
    /**
     * Finds and displays a BlogPage entity.
     *
     */
    public function showAction($id)
    {
        $user = $this->getUser();
        $em = $this->getDoctrine()->getManager();
        $entity = $em->getRepository('SifoSharedBundle:BlogPage')->find($id);

        if (!$entity) {
            throw $this->createNotFoundException('Unable to find BlogPage entity.');
        }

        return $this->render('SifoAdminBundle:show:blog_page.html.twig', array(
            'entity'      => $entity,
            'user'        => $user,
        ));
    }
    ...
    /**
     * Displays a form to edit an existing BlogPage entity.
     *
     */
    ...
    /**
    * Creates a form to edit a BlogPage entity.
    *
    * @param BlogPage $entity The entity
    *
    * @return \Symfony\Component\Form\Form The form
    */
    private function createEditForm(BlogPage $entity)
    {
        $form = $this->createForm(new BlogPageType(), $entity, array(
            'action' => $this->generateUrl('admin_blog_page_update', array('id' => $entity->getId())),
            'method' => 'POST',
        ));
    ...
    /**
     * Edits an existing BlogPage entity.
     *
     */
    public function updateAction(Request $request, $id)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_blog_page_show', array('id' => $id)));
        }
    ...
    public function removeAction($id)
    {
        ...
        return $this->render('SifoAdminBundle:remove:blog_page.html.twig', array(
            'entity'      => $entity,
            'form'        => $form->createView(),
            'user'        => $user,
        ));
    ...
    public function deleteAction(Request $request, $id)
    {
        ...
        return $this->redirect($this->generateUrl('admin_blog_page'));
    }

    /**
     * Creates a form to delete a BlogPage entity by id.
     *
    ...
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admin_blog_page_delete', array('id' => $id)))
            ->setMethod('DELETE')
