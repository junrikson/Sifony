...
use Sifo\SharedBundle\Entity\Subject;
use Sifo\AdminBundle\Form\SubjectType;
...
class SubjectController extends Controller
{
    ...
    {
        $user = $this->getUser();
        $repository = $this->getDoctrine()->getRepository('SifoSharedBundle:Subject');
        ...
        return $this->render('SifoAdminBundle:index:subject.html.twig', array(
            'entities' => $pagination,
            'paginator' => $paginator, 
            'user'     => $user,
    ...
    private function createFilterForm()
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admin_master_subject_filter'))
            ->setMethod('GET')
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_master_subject_new', array('id' => $entity->getId())));
        }
    ...
    */
    private function createCreateForm(Subject $entity)
    {
        $form = $this->createForm(new SubjectType(), $entity, array(
            'action' => $this->generateUrl('admin_master_subject_create'),
            'method' => 'POST',
        ));
    ...
    public function showAction($id)
    {
        $user = $this->getUser();
        $em = $this->getDoctrine()->getManager();
        $entity = $em->getRepository('SifoSharedBundle:Subject')->find($id);

        if (!$entity) {
            throw $this->createNotFoundException('Unable to find Subject entity.');
        }

        return $this->render('SifoAdminBundle:show:subject.html.twig', array(
            'entity' => $entity,
            'user'   => $user,
        ));
    }
    ...
    */
    ...
    {
        $form = $this->createForm(new SubjectType(), $entity, array(
            'action' => $this->generateUrl('admin_master_subject_update', array('id' => $entity->getId())),
            'method' => 'POST',
        ));
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_master_subject_show', array('id' => $id)));
        }
    ...
    public function deleteAction(Request $request, $id)
    {
        ...
        return $this->redirect($this->generateUrl('admin_master_subject'));
    }
    ...
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admin_master_subject_delete', array('id' => $id)))
            ->setMethod('DELETE')
